...
<a href="https://github.com/bkeepers/dotenv" target="_blank">dotenv</a> | Loads environment variables from `.env`. | `npm i -S dotenv` | | ![Compat](https://img.shields.io/badge/cover-both-green.svg) | ![Author](https://img.shields.io/badge/author-yes-brightgreen.svg)
<a href="https://github.com/vuejs/vuefire" target="_blank">vuefire</a> | Firebase bindings for Vue.js | `npm i vue firebase vuefire -S` | | ![Compat](https://img.shields.io/badge/cover-both-green.svg) | ![Author](https://img.shields.io/badge/author-yes-brightgreen.svg)
...
<a href="https://github.com/sarcadass/granim.js" target="_blank">granim.js</a> | Create fluid and interactive gradients animations | | | ![Compat](https://img.shields.io/badge/cover-both-green.svg)  | ![Author](https://img.shields.io/badge/author-yes-brightgreen.svg)
...
Name | Description | install | Trend | Compat | Authored
------------- | ------------- | ------------- | ------------- | ------------- | -------------
<a href="https://github.com/aframevr/aframe" target="_blank">A-Frame</a> | A web framework for building virtual reality experiences. | `npm i -S aframe` | | ![Compat](https://img.shields.io/badge/cover-both-green.svg) | ![Author](https://img.shields.io/badge/author-yes-green.svg)
...
<a href="https://github.com/KaneCohen/tokenfield" target="_blank"> tokenfield </a> | Input field with tagging/token/chip capabilities written in raw JavaScript. | ` npm i -S tokenfield` | | ![Compat](https://img.shields.io/badge/cover-both-green.svg)  | ![Author](https://img.shields.io/badge/author-yes-brightgreen.svg)
...
<a href="https://github.com/Sopamo/vue-online" target="_blank">vue-online</a> | A reactive online/offline component for vue.js |  ` npm i --save-dev vue-online` | | ![Compat](https://img.shields.io/badge/cover-both-green.svg) | ![Author](https://img.shields.io/badge/author-yes-brightgreen.svg)
